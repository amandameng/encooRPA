...
public void SendMailUse()
{
    ...
    Console.WriteLine("发件人密码：{0}", 发件人密码);
    string password = string.IsNullOrEmpty(发件人密码) ? "test@2021" : 发件人密码; // "test@2021";// 发送端密码(这个客户端重置后的密码)
    ...
    msg.From = new MailAddress(strfrom, "云扩RPA - 测试环境");
