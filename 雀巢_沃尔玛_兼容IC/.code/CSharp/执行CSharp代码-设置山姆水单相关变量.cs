...
public void Run()
{
    ...
    samWater_eto_file_path = eto_file_path.Replace("Copy of Excel To Order", $"Copy of Excel To Order_{雀巢水单流程名}");
    samWater_clean_order_file_path = clean_order_file_path.Replace("Clean and Exception", $"Clean and Exception_{雀巢水单流程名}");
    setEtoConfigDT();
}
//在这里编写您的函数或者类
/*
